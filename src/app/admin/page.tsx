        ...
        <div className="min-h-screen bg-[#050009] relative overflow-hidden">
            ...
            <header className="sticky top-0 z-40 bg-black/60 backdrop-blur-2xl border-b border-white/5 shadow-[0_10px_30px_rgba(0,0,0,0.35)] relative">
                ...
                <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-white font-orbitron tracking-[0.2em] drop-shadow-[0_0_15px_rgba(168,85,247,0.45)]">
                                ORGANIZER DASHBOARD
                            </h1>
                    ...
                    <Button
                        ...
                        className="bg-white/5 border-white/10 text-white gap-2 hover:bg-white/10 transition-all rounded-xl shadow-[0_0_20px_rgba(168,85,247,0.25)]"
                    >
            ...
            <main className="max-w-7xl mx-auto px-4 py-8 relative z-10">
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-xl overflow-hidden shadow-[0_0_45px_rgba(168,85,247,0.08)]">
                    <div className="p-6 border-b border-white/5 flex justify-between items-center bg-gradient-to-r from-purple-500/10 via-transparent to-cyan-500/10">
                        <h2 className="text-lg font-bold text-white font-orbitron tracking-[0.2em]">RECENT REGISTRATIONS</h2>
            ...
            <Dialog open={!!selectedReg} onOpenChange={() => setSelectedReg(null)}>
                <DialogContent className="bg-[#0a0a0a] border-purple-500/20 max-w-lg shadow-[0_0_35px_rgba(168,85,247,0.25)]">
                    <DialogHeader>
